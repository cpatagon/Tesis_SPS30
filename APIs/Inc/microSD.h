...
#define GET_SIZE_FAILURE                                                                           \
    "ERROR !!! obtener tamaño de la SD fallido ... \n" /**< Mensaje de error al obtener el tamaño \
                                                          de la SD */
...
#define FR_WRITE_PROTECTED_MSG                                                                     \
    "Write protected" /**< Mensaje de protección contra escritura para FR_WRITE_PROTECTED */
...
#define FR_NO_FILESYSTEM_MSG                                                                       \
    "No filesystem" /**< Mensaje de sistema de archivos no encontrado para FR_NO_FILESYSTEM */
...
#define FR_NOT_ENOUGH_CORE_MSG                                                                     \
    "Not enough core" /**< Mensaje de núcleo insuficiente para FR_NOT_ENOUGH_CORE */
#define FR_TOO_MANY_OPEN_FILES_MSG                                                                 \
    "Too many open files" /**< Mensaje de demasiados archivos abiertos para FR_TOO_MANY_OPEN_FILES \
                           */
#define FR_UNKNOWN_ERROR_MSG                                                                       \
    "Unknown error" /**< Mensaje de error desconocido para casos no especificados */
...
typedef struct {
    ...
    FATFS * pfs; /**< Puntero a la estructura FATFS utilizada para obtener información del sistema
                    de archivos. */

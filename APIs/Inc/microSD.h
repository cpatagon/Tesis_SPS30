...
#define SIZE_DIRECTORY_NAME                                                    \
  128 /**< Tamaño máximo del nombre del directorio                           \
       */
#define SIZE_BUFFER                                                            \
  256 /**< Tamaño del buffer utilizado para almacenamiento temporal */
...
#define FORCE_UNMOUNT                                                          \
  1 /**< Opción para forzar el desmontaje del sistema de archivos */
...
#define FR_DISK_ERR_MSG                                                        \
  "Disk error" /**< Mensaje de error de disco para FR_DISK_ERR */
#define FR_INT_ERR_MSG                                                         \
  "Internal error" /**< Mensaje de error interno para FR_INT_ERR */
#define FR_NOT_READY_MSG                                                       \
  "Disk not ready" /**< Mensaje de disco no listo para FR_NOT_READY */
#define FR_NO_FILE_MSG                                                         \
  "File not found" /**< Mensaje de archivo no encontrado para FR_NO_FILE */
#define FR_NO_PATH_MSG                                                         \
  "Path not found" /**< Mensaje de ruta no encontrada para FR_NO_PATH */
#define FR_INVALID_NAME_MSG                                                    \
  "Invalid name" /**< Mensaje de nombre inválido para FR_INVALID_NAME */
#define FR_DENIED_MSG                                                          \
  "Access denied" /**< Mensaje de acceso denegado para FR_DENIED */
#define FR_EXIST_MSG                                                           \
  "File exists" /**< Mensaje de archivo existente para FR_EXIST */
...
#define FR_NOT_ENABLED_MSG                                                     \
  "Not enabled" /**< Mensaje de no habilitado para FR_NOT_ENABLED */
#define FR_NO_FILESYSTEM_MSG                                                   \
  "No filesystem" /**< Mensaje de sistema de archivos no encontrado para       \
                     FR_NO_FILESYSTEM */
#define FR_MKFS_ABORTED_MSG                                                    \
  "MKFS aborted" /**< Mensaje de MKFS abortado para FR_MKFS_ABORTED */
#define FR_TIMEOUT_MSG                                                         \
  "Timeout"                    /**< Mensaje de tiempo agotado para FR_TIMEOUT */
...
typedef struct {
  ...
  char
      buffer[SIZE_BUFFER]; /**< Buffer para almacenamiento temporal de datos. */
} MicroSD;

...
#define RTC_MSG_DATE_INVALID       "[ERROR] Fecha invalida: %04hu-%02hhu-%02hhu %02hhu:%02hhu:%02hhu\r\n"
#define RTC_MSG_ERROR_LONG_INVALID "[ERROR] Longitud incorrecta. Debe tener 14 dígitos (YYYYMMDDHHMMSS).\r\n"
#define RTC_MSG_ERROR_CARACTER_INVALID "[ERROR] El string contiene caracteres no numéricos.\r\n"
#define RTC_MSG_ERROR_VALUE_INVALID "[ERROR] sscanf fallO. Valores parseados: %d\r\n"
...
#define MSM_RTC_HORA_NO_VALIDA     "[RTC] Hora no válida. Usando hora de compilación.\r\n"


#define RTC_TEST_INIT_MSG                "[TEST] Intentando configurar RTC con fecha fija...\r\n"
#define RTC_TEST_SUCCESS_MSG             "[TEST] RTC configurado con exito.\r\n"
#define RTC_TEST_FAILURE_MSG             "[TEST] Error al configurar RTC.\r\n"
#define RTC_TEST_VERIF_MSG_FMT           "[TEST] Verificacion: %04d-%02d-%02d %02d:%02d:%02d\r\n"
#define RTC_TEST_COMPILE_TIME_FMT        "[TEST] Verificacion fecha compilacion: %04d-%02d-%02d %02d:%02d:%02d\r\n"
...
#define RTC_PARSE_FAIL_MSG        "Tiempo expirado o entrada incompleta. Se mantiene hora RTC actual.\r\n"
